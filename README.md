...
- Average Sales: Calculation of average sales per product to benchmark performance.
- Sales Status: Identification of sales performance relative to the average (above average, below average, or at average).
- Yearly Sales: Analysis of sales per product across different years to identify trends.
- Yearly Progress: Tracking of annual sales trends to highlight significant changes.
